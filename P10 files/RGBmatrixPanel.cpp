/*
RGBmatrixPanel Arduino library for P10 1/4 scan panels with 'snake pattern' LED layout, by Ruud van Reenen.
...
For example: RGBmatrixPanel matrix(A, B, C, CLK, LAT, OE, true, 2); 		
Where 2 is the number of panels. true = for double buffering: this reduces flickering but uses twice the amount of memory.

Based on the RGBmatrixPanel Arduino library for Adafruit 16x32 and 32x32 RGB LED
